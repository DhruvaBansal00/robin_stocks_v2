...
def test_get_futures_contract_returns_result_payload() -> None:
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value={"result": {"id": "C1", "symbol": "/ESH26"}}) as rg,
...
def test_get_futures_contract_uppercase_normalization() -> None:
    ...
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value={"result": {"id": "C1"}}),
...
def test_get_futures_contract_no_result_returns_none() -> None:
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value={"detail": "not found"}),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
    ):
...
def test_get_futures_contract_info_filter() -> None:
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value={"result": {"id": "C1", "multiplier": "50"}}),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
    ):
...
def test_get_futures_quote_resolves_symbol_then_fetches() -> None:
    with (
        patch("robin_stocks.robinhood.futures.id_for_futures_contract", return_value="cid-1") as idf,
...
def test_get_futures_quote_by_id_unwraps_nested_data() -> None:
    ...
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value=body),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
    ):
...
def test_get_futures_quote_by_id_empty_data_returns_none() -> None:
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value={"data": []}),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
    ):
...
def test_get_futures_quotes_multiple_symbols_joins_ids() -> None:
    ...
    with (
        patch("robin_stocks.robinhood.futures.id_for_futures_contract", side_effect=["a-id", "b-id"]),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
        patch(
            "robin_stocks.robinhood.futures.request_get", return_value={"data": [{"data": {"x": 1}}, {"data": {"x": 2}}]}
        ) as rg,
    ):
...
def test_get_futures_quotes_accepts_single_string() -> None:
    ...
    with (
        patch("robin_stocks.robinhood.futures.id_for_futures_contract", return_value="cid-1"),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
...
def test_get_all_futures_orders_auto_detects_account_id_when_missing() -> None:
    ...
    with (
        patch("robin_stocks.robinhood.futures.get_futures_account_id", return_value="resolved-acct") as gai,
...
def test_get_filled_futures_orders_auto_detects_account() -> None:
    with (
        patch("robin_stocks.robinhood.futures.get_futures_account_id", return_value="auto-acct") as gai,
        patch("robin_stocks.robinhood.futures.request_get", return_value={"results": [], "next": None}),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
    ):
...
def test_get_futures_account_id_returns_none_when_empty_list() -> None:
    with (
        patch("robin_stocks.robinhood.futures.request_get", return_value=[]),
        patch("robin_stocks.robinhood.futures.update_session_for_futures"),
    ):
        assert futures.get_futures_account_id() is None
