...
@mcp.tool()
@safe_tool()
async def tda_get_hours_for_markets(markets: str | list[str], date: str, jsonify: bool | None = None) -> Any:
...
@mcp.tool()
@safe_tool()
async def tda_get_hours_for_market(market: str, date: str, jsonify: bool | None = None) -> Any:
...
@mcp.tool()
@safe_tool()
async def tda_get_movers(market: str, direction: str, change: str, jsonify: bool | None = None) -> Any:
