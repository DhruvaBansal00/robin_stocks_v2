...
@mcp.tool()
@safe_tool()
async def rh_get_futures_contract(symbol: str, info: Optional[str] = None) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_futures_contracts_by_symbols(
    symbols: list[str], info: Optional[str] = None
) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_futures_quote(symbol: str, info: Optional[str] = None) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_futures_quotes(symbols: list[str], info: Optional[str] = None) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_futures_quote_by_id(
    contract_id: str, info: Optional[str] = None
) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_futures_positions(
    account_id: Optional[str] = None, info: Optional[str] = None
) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_all_futures_orders(
    account_id: Optional[str] = None, info: Optional[str] = None
) -> Any:
...
@mcp.tool()
@safe_tool()
async def rh_get_filled_futures_orders(
    account_id: Optional[str] = None, info: Optional[str] = None
) -> Any:
...
async def rh_get_futures_order_info(
    ...
    return await to_thread(
        rh.get_futures_order_info, order_id, account_id=account_id, info=info
    )
